...
claude mcp add --scope user apple-docs -- node ~/apple-docs-mcp-server/dist/index.js
```

Done. The `--scope user` flag makes it available in every project, not just this folder.
